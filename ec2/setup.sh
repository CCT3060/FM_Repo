...
echo ""
echo "  Next steps:"
echo "  1. (Option A – use local PostgreSQL – recommended)"
echo "     Run:  sudo bash ${APP_ROOT}/ec2/setup-postgres.sh <db-password> [supabase-direct-url]"
echo "     Then set DATABASE_URL=postgresql://fmapp:<db-password>@localhost:5432/fmapp"
echo "          SUPABASE_DB_SSL=disable in /var/www/fmapp/backend/.env"
echo ""
echo "  1. (Option B – keep Supabase)"
echo "     Set DATABASE_URL=<supabase-pooler-url> in /var/www/fmapp/backend/.env"
echo ""
echo "  2. Add remaining secrets to /var/www/fmapp/backend/.env:"
echo "     JWT_SECRET, ALLOW_ORIGIN=https://fm.catalystsolutions.eco, PORT=4000"
echo ""
echo "  3. Add GitHub Secrets: EC2_HOST, EC2_USER, EC2_SSH_KEY"
echo "  4. Push to trigger GitHub Actions deploy"
echo "========================================================"
